...
__declspec(naked) void New1CollisionObjectHook() {
...
__declspec(naked) void New2CollisionObjectHook() {
...
__declspec(naked) void New3CollisionObjectHook() {
...
__declspec(naked) void DisposeCollisionObjectHook() {
...
__declspec(naked) void MaterialPropertyHook() {
...
__declspec(naked) void CoordinateJackHook() {
...
__declspec(naked) void ObjectCullHook() {
