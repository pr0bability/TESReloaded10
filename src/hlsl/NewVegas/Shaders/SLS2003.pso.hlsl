...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    float3 lighting = getSunLighting(float3x3(red.xyz, green.xyz, blue.xyz), IN.texcoord_1.xyz, PSLightColor[0].rgb, IN.location, normal, AmbientColor.rgb, baseColor.rgb);
