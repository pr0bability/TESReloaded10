...
HighProcess* (__thiscall* NewHighProcess)(HighProcess*) = (HighProcess* (__thiscall*)(HighProcess*))Hooks::NewHighProcess;
...
void (__thiscall* ManageItem)(InventoryMenu*, int, TileRect*) = (void (__thiscall*)(InventoryMenu*, int, TileRect*))Hooks::ManageItem;
...
int (__thiscall* ProcessAction)(Character*, float, float) = (int (__thiscall*)(Character*, float, float))Hooks::ProcessAction;
...
UInt8 (__thiscall* ProcessControlAttack)(PlayerCharacter*) = (UInt8 (__thiscall*)(PlayerCharacter*))Hooks::ProcessControlAttack;
...
void (__thiscall* AttackHandling)(Actor*, UInt8, TESObjectREFR*, TESObjectREFR*) = (void (__thiscall*)(Actor*, UInt8, TESObjectREFR*, TESObjectREFR*))Hooks::AttackHandling;
...
InventoryChanges::EntryData* (__thiscall* GetEquippedWeaponData)(HighProcess*, UInt8) = (InventoryChanges::EntryData* (__thiscall*)(HighProcess*, UInt8))Hooks::GetEquippedWeaponData;
...
bool (__thiscall* SetEquippedWeaponData)(HighProcess*, InventoryChanges::EntryData*, NiNode*) = (bool (__thiscall*)(HighProcess*, InventoryChanges::EntryData*, NiNode*))Hooks::SetEquippedWeaponData;
...
void (__thiscall* EquipItem)(InventoryChanges::Data*, TESForm*, int, Actor*, ExtraDataList*, UInt8, UInt8) = (void (__thiscall*)(InventoryChanges::Data*, TESForm*, int, Actor*, ExtraDataList*, UInt8, UInt8))Hooks::EquipItem;
...
void (__thiscall* UnequipItem)(InventoryChanges::Data*, UInt8*, TESForm*, int, Actor*, ExtraDataList*, UInt8, UInt8) = (void (__thiscall*)(InventoryChanges::Data*, UInt8*, TESForm*, int, Actor*, ExtraDataList*, UInt8, UInt8))Hooks::UnequipItem;
...
void (__thiscall* EquipWeapon)(Actor*, TESObjectWEAP*) = (void (__thiscall*)(Actor*, TESObjectWEAP*))Hooks::EquipWeapon;
...
void (__thiscall* UnequipWeapon)(Actor*) = (void (__thiscall*)(Actor*))Hooks::UnequipWeapon;
...
void (__thiscall* EquipShield)(Actor*, TESObjectARMO*) = (void (__thiscall*)(Actor*, TESObjectARMO*))Hooks::EquipShield;
...
void (__thiscall* EquipLight)(Actor*, TESObjectLIGH*) = (void (__thiscall*)(Actor*, TESObjectLIGH*))Hooks::EquipLight;
...
void (__thiscall* UnequipLight)(Character*) = (void (__thiscall*)(Character*))Hooks::UnequipLight;
...
void (__thiscall* HideEquipment)(Actor*, TESForm*, UInt8) = (void (__thiscall*)(Actor*, TESForm*, UInt8))Hooks::HideEquipment;
...
InventoryChanges::EntryData* (__thiscall* GetEquippedLightData)(HighProcess*, UInt8) = (InventoryChanges::EntryData* (__thiscall*)(HighProcess*, UInt8))Hooks::GetEquippedLightData;
...
void (__thiscall* SaveGame)(InventoryChanges::EntryData*) = (void (__thiscall*)(InventoryChanges::EntryData*))Hooks::SaveGame;
...
__declspec(naked) void UnequipTorchHook() {
...
__declspec(naked) void EquipItemWornHook() {
...
__declspec(naked) void SetWeaponRotationPositionHook() {
...
__declspec(naked) void MenuMouseButtonHook() {
